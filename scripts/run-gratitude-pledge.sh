...
STRESS_LEVEL="${STRESS_LEVEL:-quick}" cargo run --bin lua_runner --manifest-path simulation/Cargo.toml -- simulation/scripts/scenarios/sync_engine_gratitude_pledge.lua | cargo run -p indras-realm-viewer --bin omni-viewer-v2 -- "$@"
